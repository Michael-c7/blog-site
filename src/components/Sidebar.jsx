...
const Sidebar = (props) => {
    ...
    return (
        <aside className={`fixed top-0 right-0 h-[100%] bg-white drop-shadow w-[20rem] max-[320px]:w-[100%] px-8 py-10 z-50 transition-all duration-[375ms] ${isSidebarOpen ? "right-[0]" : "right-[-24rem]"}`} >
